...
const FALLBACK_AREAS: PracticeAreaItem[] = [
  ...
  { title: 'Real Property', slug: { current: 'real-property' } },
  {
    ...
    slug: { current: 'receivership--conservatorship' },
  },
...
export default function PracticeAreas({
  ...
  return (
    <section id='practice-areas' className='w-full bg-[#f3f4f6]'>
          ...
          <div className='grid w-full grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>
            {displayAreas.map((area) => (
              <Link
                ...
                className='flex items-center gap-5 rounded-lg p-5 transition-colors hover:bg-black/5'
              >
                <Image
                  ...
                  height={34}
                />
                <span className='font-[family-name:var(--font-noto)] text-base font-medium leading-[34px] tracking-tight text-gray-90'>
                  {area.title}
                </span>
              </Link>
            ))}
